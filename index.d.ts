...
declare class bulmaCalendar {
  ...
  removeListeners(
    eventName: bulmaCalendar.EventType,
    middleware?: boolean
  ): void;

  middleware<T extends bulmaCalendar.EventType>(
    eventName: T,
    fn: (event: bulmaCalendar.Event<T>) => void
  ): void;
  ...
  once<T extends bulmaCalendar.EventType>(
    name: T,
    callback: (event: bulmaCalendar.Event<T>) => void
  ): void;

  emit(
    name: bulmaCalendar.EventType,
    data: bulmaCalendar,
    silent?: boolean
  ): void;
